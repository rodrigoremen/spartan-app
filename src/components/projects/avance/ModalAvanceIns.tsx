...
interface ModalAgregarAvanceInsProps {
    agregarTarea: (tarea: Tarea) => void;
}

const ModalAgregrarAvanceIns: React.FC<ModalAgregarAvanceInsProps> = ({ agregarTarea }) => {
...
export default ModalAgregrarAvanceIns;